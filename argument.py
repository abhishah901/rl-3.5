def add_arguments(parser):
    ...
    parser.add_argument('--log_file', default=None, help='log file for recording DQN(timesteps v.s. average rewards)')
    parser.add_argument('--DQN', action='store_true')
 #   parser.add_argument('--DoubleDQN', action='store_false')
 #   parser.add_argument('--DuelingDQN', action='store_true')
    parser.add_argument('--model_dqn', default='DQN_model', help='model path for DQN')
    return parser
